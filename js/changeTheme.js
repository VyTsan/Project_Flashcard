...
const changeCardBtnEle = document.querySelector('.change-card');
const tempBtnEle = document.querySelectorAll('.tempBtn');
var theme = 1;
...
function changeTheme() {
  ...
  if (theme === 2) {
    ...
    changeCardBtnEle.classList.remove('btn-success');
    changeCardBtnEle.classList.add('btn-primary');
  } else {
    ...
    changeCardBtnEle.classList.remove('btn-primary');
    changeCardBtnEle.classList.add('btn-success');
  }
}
